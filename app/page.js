  ...
  return (
    <Container>
      <div>
        <div className=" h-[500px] sm:h-[450px]  ">
          <div className="imgset  h-full w-full   flex items-center justify-center ">
            <div className="text-white text-center w-full sm:w-5/6 mx-auto m-2 md:m-0">
              ...
              <p className=" text-3xl sm:text-4xl md:text-5xl  break-all">
                Experience Reputation Result
              </p>

              <p className=" text-lg md:text-xl mt-4 mb-2">
                The Smart choice for Personal Injury and defense Attorneys
              </p>
              <button className="py-2 px-2 bg-white border-2 rounded-md text-black font-medium borde my-4">
                Get Consultation
              </button>
              <p className="text-sm">
                Offices in Dallas & Fort Worth. Call Us Toll Free: (800)
                555-0101
              </p>
            </div>
          </div>
        ...
        <div className="bh-white px-3  py-8">
          <p className="w-full mx-auto sm:w-5/6 md:max-w-screen-md ">
            Our team of experienced lawyers at Smith & Associates can help you
            as we have thousands of others in Texas. We understand this can be a
            difficult time for you and your family. We are here to help.
          </p>
        </div>
      </div>
      ...
      <div className="my-20 px-4">
        ...
        <div className="my-8">
          <div className="flex   justify-center items-center lg:justify-between xl:justify-start  flex-wrap  ">
            <div className=" basis-[100%] sm:basis-[48%] md:basis-[45%] lg:basis-[32%] xl:basis-1/4 flex items-center justify-between  p-2  ">
